...
export function CalculadoraSection() {
  ...
  const [usarTasaMensual, setUsarTasaMensual] = useState(false);
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={monto}
                    onChange={(e) =>
                      setMonto(Number.parseFloat(e.target.value))
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={tasaAnual}
                    onChange={(e) =>
                      setTasaAnual(Number.parseFloat(e.target.value))
                    }
                    className="border-gray-300 focus:border-blue-500"
                  />
                  {/* ... Encabezados y tarjetas omitidas por brevedad ... */}
                  <div className="space-y-2">
                    <Label>
                      ¿Usar tasa de interés mensual directamente?
                      <input
                        type="checkbox"
                        checked={usarTasaMensual}
                        onChange={() => setUsarTasaMensual(!usarTasaMensual)}
                        className="ml-2"
                      />
                    </Label>
                  </div>
                  ...
                  {usarTasaMensual && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={tasaMensual}
                        onChange={(e) =>
                          setTasaMensual(Number.parseFloat(e.target.value))
                        }
                        className="border-gray-300 focus:border-blue-500"
                      />
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={periodicidad} onValueChange={setPeriodicidad}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="cuatrimestral">
                        Cuatrimestral
                      </SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={periodoGracia}
                    onChange={(e) =>
                      setPeriodoGracia(Number.parseInt(e.target.value))
                    }
                    min="0"
                    max={plazo - 1}
                    className="border-gray-300 focus:border-blue-500"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-blue-navy">
                    $
                    {typeof resumen.cuota === "number"
                      ? resumen.cuota.toFixed(2)
                      : resumen.cuota}
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-red-dark">
                    ${resumen.totalIntereses.toFixed(2)}
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-blue-navy">
                    ${resumen.totalAmortizacion.toFixed(2)}
                  </p>
                </motion.div>
